...
abstract class _Empty extends SettingsState {
...
abstract class _Loading extends SettingsState {
...
class _$_Loaded extends _Loaded {
  const _$_Loaded(this.settings) : super._();
...
abstract class _Saving extends SettingsState {
...
abstract class _Saved extends SettingsState {
...
class _$_Failure extends _Failure {
  const _$_Failure(this.mesage) : super._();
  ...
  @override
  String toString() {
    return 'SettingsState.error(mesage: $mesage)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(mesage));
